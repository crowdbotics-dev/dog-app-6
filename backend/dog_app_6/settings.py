"""
Django settings for dog_app_6 project.
...
WSGI_APPLICATION = 'dog_app_6.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dog_app_6 API",
    "DESCRIPTION": "API documentation for dog_app_6 App",
    "VERSION": "v1",
}
